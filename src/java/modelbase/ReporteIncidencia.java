...
public class ReporteIncidencia  implements java.io.Serializable {
    ...
    public ReporteIncidencia(int idReporte, SesionDeLaboratorio sesionDeLaboratorio, String nombre, byte[] documento, Date fecha, String estado, Date actualizacion) {
    ...
    public ReporteIncidencia(int idReporte, SesionDeLaboratorio sesionDeLaboratorio, String nombre, byte[] documento, Date fecha, String estado, Date actualizacion, Set historialEmergencias) {
       this.idReporte = idReporte;
       this.sesionDeLaboratorio = sesionDeLaboratorio;
       this.nombre = nombre;
       this.documento = documento;
