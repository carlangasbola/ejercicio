...
@Named(value = "managedBeanGraficas")
@RequestScoped

public class ManagedBeanGraficas implements Serializable {
    ...
    private BarChartModel initBarModel() {
        ...
        ChartSeries explosivos = new ChartSeries();
        explosivos.setLabel("Explosivos");
        explosivos.set("Reactivos", 500);
        
        ChartSeries gases = new ChartSeries();
        gases.setLabel("Gases, liquidos y solidos inflamables");
        gases.set("Gases, liquidos y solidos inflamables", 600);
        
        ChartSeries gasesapresion = new ChartSeries();
        gasesapresion.setLabel("Gases a presion");
        gasesapresion.set("Gases a presion", 200);
        
        ChartSeries sustanciascomburentes = new ChartSeries();
        sustanciascomburentes.setLabel("Sustancias comburentes");
        sustanciascomburentes.set("Sustancias comburentes", 1000);
        
        ChartSeries sustanciasperjudiciales = new ChartSeries();
        sustanciasperjudiciales.setLabel("Sustancias perjudiciales para la salud");
        sustanciasperjudiciales.set("Sustancias perjudiciales para la salud", 900);
        
        ChartSeries sustanciascorrosivas = new ChartSeries();
        sustanciascorrosivas.setLabel("Sustancias corrosivas");
        sustanciascorrosivas.set("Sustancias corrosivas", 1500);
        
        ChartSeries sustanciasnosivas = new ChartSeries();
        sustanciasnosivas.setLabel("Sustancias nosivas");
        sustanciasnosivas.set("Sustancias nosivas", 1000);
        
        ChartSeries sustanciastoxicas = new ChartSeries();
        sustanciastoxicas.setLabel("Sustancias toxicas");
        sustanciastoxicas.set("Sustancias toxicas", 1000);
        
        ChartSeries sustanciaspeligrosas = new ChartSeries();
        sustanciaspeligrosas.setLabel("Sustancias peligrosas para el medio ambiente");
        sustanciaspeligrosas.set("Sustancias peligrosas para el medio ambiente", 1000);
        
        model.addSeries(explosivos);
        model.addSeries(gases);
        model.addSeries(gasesapresion);
        model.addSeries(sustanciascomburentes);
        model.addSeries(sustanciasperjudiciales);
        model.addSeries(sustanciascorrosivas);
        model.addSeries(sustanciasnosivas);
        model.addSeries(sustanciastoxicas);
        model.addSeries(sustanciaspeligrosas);
    ...
    private void createAnimatedModels() {
        ...
        animatedModel2.setTitle("Residuos totales");
